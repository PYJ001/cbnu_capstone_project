...
from src.Interface import _draw_detections, _make_depth_view
...
class RobotInterfaceWindow(QMainWindow):
    ...
    def update_camera(self, packet):
        ...
        rgb_vis = _draw_detections(frame, yolo_robot, yolo_world)
        depth_vis = _make_depth_view(depth, rgb_vis.shape)
